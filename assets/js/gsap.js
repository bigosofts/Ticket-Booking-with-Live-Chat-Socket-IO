...
setTimeout(() => {
  setInterval(() => {
    let item = document.getElementById("h2-text");
    if (item) {
      item.innerHTML = "Active Ascents";
    }
  }, 20000);
}, 7000);
...
setTimeout(() => {
  setInterval(() => {
    let item = document.getElementById("h1-text");
    if (item) {
      item.innerHTML = "Making exploration easy";
    }
  }, 20000);
  //change color randomly
  var div = document.getElementById("h1-text");
  if (div) {
    div.style.color = "rgb(167 216 251)";
  }
}, 9000);
...
setTimeout(() => {
  setInterval(() => {
    let item = document.getElementById("h1-text");
    if (item) {
      item.innerHTML = "Create adventures";
    }
  }, 20000);
}, 13000);
